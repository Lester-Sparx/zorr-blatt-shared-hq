...
class ContextE2ProvenanceIntegrityTests(unittest.TestCase):
        ...
        facts = [
            {
                ...
                "verified": True,
                "authority": "GITHUB",
                "created_at": "2026-08-31T20:42:00Z",
                "scope_tags": ["LESTER", "SECURITY_R02"],
                "source_refs": ["github:issue-comment:101"],
                "supersedes": [],
            },
            {
                "schema": "ZB_CONTEXT_FACT_V1",
                "fact_id": "new-physical-blocker",
                "class": "E2",
                "key": "NEW_PHYSICAL_BLOCKER",
                "value": True,
                "exclusive": True,
                "verified": True,
                "authority": "GITHUB",
                "created_at": "2026-08-31T20:42:01Z",
                "scope_tags": ["LESTER", "SECURITY_R02"],
                "source_refs": ["github:issue-comment:102"],
                "supersedes": [],
            },
            {
                "schema": "ZB_CONTEXT_FACT_V1",
                "fact_id": "process-mutation-count",
                "class": "E2",
                "key": "PROCESS_MUTATION_COUNT",
                "value": 1,
                "exclusive": True,
                "verified": True,
                "authority": "GITHUB",
                "created_at": "2026-08-31T20:42:02Z",
                "scope_tags": ["LESTER", "SECURITY_R02"],
                "source_refs": ["github:test:process-mutation-count"],
                "supersedes": [],
            },
            {
                "schema": "ZB_CONTEXT_FACT_V1",
                "fact_id": "prior-error-signature",
                "class": "E2",
                "key": "PROCESS_MUTATION_ERROR_SIGNATURE",
                ...
                "verified": True,
                "authority": "GITHUB",
                "created_at": "2026-08-31T20:42:03Z",
                "scope_tags": ["LESTER", "SECURITY_R02"],
                "source_refs": ["github:issue-comment:103"],
                "supersedes": [],
            },
        ]
        return {
            ...
            "jit_facets": {},
            "missing_facets": [],
            "source_refs": ["github:issue-comment:101", "github:issue-comment:102", "github:issue-comment:103"],
        }
    ...
    def test_exact_github_comment_readback_allows_distinct_evidence_bound_blocker(self) -> None:
        result = hq_pre_action.evaluate_pre_action_with_github_freshness(
            self.context(),
            context_packet=self.evidence_bound_packet(),
            github_api=FakeGitHubApi(self.comments()),
        )
    ...
    def test_github_comment_value_mismatch_fails_closed(self) -> None:
        result = hq_pre_action.evaluate_pre_action_with_github_freshness(
            self.context(),
            context_packet=self.evidence_bound_packet(),
            github_api=FakeGitHubApi(self.comments(wrong_current_signature=True)),
        )
        self.assertEqual(
            (result["decision"], result["reason"]),
            ("BLOCK", "DURABLE_CONTEXT_EVIDENCE_SOURCE_NOT_PROVEN"),
