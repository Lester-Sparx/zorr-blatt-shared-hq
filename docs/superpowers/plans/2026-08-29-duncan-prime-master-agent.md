# DUNCAN PRIME Master-Agent Identity Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Make DUNCAN PRIME the durable primordial/master identity root, define SALVADOR as an internal specialist facet, and bind Night School to stylish-anime mastery as its highest learning objective.
...
### Task 1: Bootstrap identity + anime-learning law
...
- Produces: durable identity topology and anime-priority learning law restored by every ZORR session.
...
**Interfaces:**
- Consumes: candidate branch from exact current main.
